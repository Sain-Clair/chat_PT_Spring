...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:8080", "http://localhost:8081",
                "https://chunsik.shop", "ws://localhost/springpt/ws-stomp/**"));
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        // 토큰 검증을 하지 않을 요청
                        .requestMatchers("/login", "/checkToken", "/images/**", "/ws-stomp/**", "/service/**", "/validCheckEmail/**", "/kakao/**", "https://kauth.kakao.com/**", "https://kapi/kakao.com/**" ,"/v2/user/me/")
                        .permitAll()
