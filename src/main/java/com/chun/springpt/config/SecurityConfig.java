    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((auth) -> auth
                        // 토큰 검증을 하지 않을 요청
                        .requestMatchers("/","/hello","/login", "/checkToken", "/images/**", "/ws-stomp/**", "/service/**", "/signUp/**", "/validCheckEmail/**", "/kakao/**", "https://kauth.kakao.com/**", "https://kapi/kakao.com/**" ,"/chatbot/**","/v2/user/me/")
                        .permitAll()
