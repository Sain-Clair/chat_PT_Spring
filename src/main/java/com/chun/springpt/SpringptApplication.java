	...
	public WebMvcConfigurer crosConfigure() {
		...
		return new WebMvcConfigurer() {
			...
			public void addCorsMappings(CorsRegistry registry) {
				...
				registry.addMapping("/**")
						.allowedOrigins("http://localhost:3000/", "https://chunsik.shop/", "http://www.chatpt.shop/", "http://chatpt.shop:8888/","http://www.chatpt.shop:8888/", "http://3.37.155.116:8888/","http://localhost/", "ws://localhost", "http://localhost:9000/")
						.allowedHeaders("*")
