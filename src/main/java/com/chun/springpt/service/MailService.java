...
public class MailService {
    ...
    private static final String senderEmail = "chat.pt.service@gmail.com";
    ...
    public MimeMessage createMail(String mail){
        ...
        try {
            ...
            body += "<img src='https://chat-pt.s3.ap-northeast-2.amazonaws.com/etc/email.png' style='width: 350px; height: auto;'/>";
